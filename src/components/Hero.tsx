  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Artista tatuador trabalhando"
      ...
      <div className="relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-center pt-20">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <h1 className="text-6xl md:text-8xl font-display font-black text-foreground mb-4 tracking-tight text-shadow-hero">
            Art <span className="text-gold">TATTO</span>
          </h1>
          
          <p className="text-2xl md:text-3xl text-gold font-display italic mb-6">
            Transformando Pele em Arte Desde 2015
          </p>
          
          <p className="text-lg text-foreground/80 max-w-2xl font-light leading-relaxed mb-10">
            Cada tatuagem é uma obra única, criada com paixão, técnica e dedicação absoluta. 
            Nosso compromisso é transformar suas ideias em arte permanente que conta sua história.
          </p>
