        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gold/10 flex items-center justify-center text-gold hover:bg-gold hover:text-primary-foreground transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Portfólio", "Serviços", "Sobre Nós", "Contato"].map(link => <li key={link}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Old School", "Tribal", "Oriental", "Realista"].map(style => <li key={style}>
