...
type TattooStyle = "Todos" | "Old School" | "Realismo" | "Fine Line" | "Blackwork" | "Pontilhismo" | "Oriental" | "Maori" | "Geométrico" | "Single Line";
...
const portfolioItems: PortfolioItem[] = [{
  ...
  image: oldSchool1,
  style: "Old School",
  description: "Âncora tradicional com rosas"
}, {
  id: 2,
  image: oldSchool2,
  style: "Old School",
  description: "Sereia clássica vintage"
}, {
  id: 3,
  image: realismo1,
  style: "Realismo",
  ...
  image: fineLine1,
  style: "Fine Line",
  description: "Flores delicadas em traço fino"
}, {
  id: 6,
  image: fineLine2,
  style: "Fine Line",
  description: "Borboleta minimalista"
}, {
  id: 7,
  image: blackwork1,
  style: "Blackwork",
  description: "Mandala em blackwork"
}, {
  id: 8,
  image: blackwork2,
  style: "Blackwork",
  description: "Floresta em silhueta"
}, {
  id: 9,
  image: dotwork1,
  style: "Pontilhismo",
  description: "Mandala geométrica em pontos"
}, {
  id: 10,
  image: dotwork2,
  style: "Pontilhismo",
  description: "Rosa em pontilhismo"
}, {
  id: 11,
  image: oriental1,
  style: "Oriental",
  description: "Dragão japonês tradicional"
}, {
  id: 12,
  image: oriental2,
  style: "Oriental",
  description: "Carpa koi com ondas"
}, {
  id: 13,
  image: maori1,
  style: "Maori",
  description: "Braçadeira tribal maori"
}, {
  id: 14,
  image: maori2,
  style: "Maori",
  ...
  image: geometrico2,
  style: "Geométrico",
  description: "Padrões sagrados"
}, {
  id: 17,
  image: singleLine1,
  style: "Single Line",
  description: "Rosto em linha única"
}, {
  id: 18,
  image: singleLine2,
  style: "Single Line",
  description: "Flor contínua"
}];
const styles: TattooStyle[] = ["Todos", "Old School", "Realismo", "Fine Line", "Blackwork", "Pontilhismo", "Oriental", "Maori", "Geométrico", "Single Line"];
  ...
  return <section id="portfolio" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <AnimatePresence mode="wait">
          {activeStyle !== "Todos" && <motion.div key={activeStyle} initial={{
          opacity: 0,
          height: 0
        }} animate={{
          opacity: 1,
      ...
      <AnimatePresence>
        ...
        opacity: 0
      }} className="fixed inset-0 z-50 flex items-center justify-center bg-background/95 backdrop-blur-sm p-4" onClick={() => setSelectedImage(null)}>
            <motion.div initial={{
          scale: 0.9,
          opacity: 0
        }} animate={{
          ...
          stiffness: 300
              ...
              <img src={selectedImage.image} alt={selectedImage.description} className="w-full h-full object-contain rounded-2xl" />
              ...
              <button onClick={() => setSelectedImage(null)} className="absolute top-4 right-4 w-10 h-10 bg-card rounded-full flex items-center justify-center text-foreground hover:bg-gold hover:text-background transition-colors">
